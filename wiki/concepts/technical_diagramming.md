...
tags: [documentation, visualization, engineering]
...
- **Aesthetics:** Professional visual styles that enhance readability.
- **Automation:** Generating diagrams from code or natural language.
