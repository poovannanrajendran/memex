...
entity_type: tool
tags: [diagrams, claudecode, open-source, visualization]
...
## Key facts
- Supports 14 diagram types (UML, Sequence, Multi-Agent flows, etc.).
- Includes 7 distinct visual styles (e.g., Dark Terminal, Blueprint).
